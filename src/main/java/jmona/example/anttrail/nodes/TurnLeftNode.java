...
/**
 * Node which turns an Ant left (counterclockwise) by 90&deg;.
 * 
 * @author Jeffrey Finkelstein
 * @since 0.3
 */
public class TurnLeftNode extends AntTerminalNode {

  /** The symbol of the operation represented by this Node. */
  public static final String SYMBOL = "LEFT";
   ...
   *          The Ant to control.
   */
  public TurnLeftNode(final Ant initialAnt) {
    super(initialAnt);
  }
   ...
   */
  @Override
  public TurnLeftNode deepCopy() {
    return new TurnLeftNode(this.ant());
  }

  /**
   * Turn the Ant left (counterclockwise) by 90&deg;.
   * 
