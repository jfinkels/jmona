...
import jmona.gp.example.calc.functions.AdditionFunction;
...
public class FunctionAddition implements
   ...
   */
  public static FunctionAddition newInstance() {
    return FunctionAddition.INSTANCE;
  }

  /**
   * Returns a function which is the sum of the two specified input functions.
   * 
   * @param object1
   *          A function.
   * @param object2
