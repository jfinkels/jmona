...
public class EquivalenceException extends Exception {
  ...
  private static final long serialVersionUID = -9075473097085903596L;
   ...
   */
  public EquivalenceException(final String message) {
    super(message);
  }
   ...
   */
  public EquivalenceException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   *          The cause of this Exception.
   */
  public EquivalenceException(final Throwable cause) {
    super(cause);
  }
