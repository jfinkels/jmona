 ...
 */
public class TargetedFitnessFunction<T, V> implements FitnessFunction<T> {

  /** The mapping for an individual. */
  private Function<T, V> mapping = null;
  /**
   ...
   */
  public void setMapping(final Function<T, V> newMapping) {
