...
public class PeriodicPostProcessorTester {
  ...
  /**
   * Test method for
   * {@link jmona.impl.PeriodicPostProcessor#process(jmona.EvolutionContext)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.impl.PeriodicPostProcessor#processAtInterval(jmona.EvolutionContext)}
   * .
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.impl.PeriodicPostProcessor#setPeriod(int)}.
   */
  @Test
