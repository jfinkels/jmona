/**
 * StandardizedFitnessComparatorTester.java
 * 
 ...
 * @since 0.3
 */
public class StandardizedFitnessComparatorTester {
  ...
  public void testSetFitnesses() {
    final StandardizedFitnessComparator<ExampleIndividual> comparator = new StandardizedFitnessComparator<ExampleIndividual>();
