...
public class FunctionAdditionTester {
  ...
  /**
   * Test method for
   * {@link jmona.gp.example.calc.operations.FunctionAddition#operate(jmona.gp.example.calc.functions.SingleInputFunction, jmona.gp.example.calc.functions.SingleInputFunction)}
   * .
   */
  @Test
