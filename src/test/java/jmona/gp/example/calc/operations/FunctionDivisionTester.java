...
public class FunctionDivisionTester {
  ...
  /**
   * Test method for
   * {@link jmona.gp.example.calc.operations.FunctionDivision#operate(jmona.gp.example.calc.functions.SingleInputFunction, jmona.gp.example.calc.functions.SingleInputFunction)}
   * .
   */
  @Test
