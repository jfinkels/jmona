...
public class FunctionSubtractionTester {
  ...
  /**
   * Test method for
   * {@link jmona.gp.example.calc.operations.FunctionSubtraction#operate(jmona.gp.example.calc.functions.SingleInputFunction, jmona.gp.example.calc.functions.SingleInputFunction)}
   * .
   */
  @Test
  public void testOperate() {
    final UniformBinaryOperation<SingleInputFunction<Double, Double>> operation = FunctionSubtraction
        .newInstance();
