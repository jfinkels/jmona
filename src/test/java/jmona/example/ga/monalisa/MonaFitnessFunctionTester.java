...
public class MonaFitnessFunctionTester {
  ...
  public static final File BIG_TESTFILE = new File(
      "src/test/resources/jmona/example/ga/monalisa/images/monalisa.jpg");
  ...
  public static final File COLORS_TESTFILE = new File(
      "src/test/resources/jmona/example/ga/monalisa/images/example-transparency.png");
  ...
  public static final File OVERLAPPING_TESTFILE = new File(
      "src/test/resources/jmona/example/ga/monalisa/images/purple-red.png");
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.MonaFitnessFunction#distance(int, int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.MonaFitnessFunction#fitness(jmona.example.ga.monalisa.MonaIndividual)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.MonaFitnessFunction#getColor(int, int)}.
   */
  @Test
