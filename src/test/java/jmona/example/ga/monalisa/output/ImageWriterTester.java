...
public class ImageWriterTester {
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.output.ImageWriter#toImage(jmona.example.ga.monalisa.MonaIndividual, int, int)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.output.ImageWriter#writeImage(java.awt.image.BufferedImage, java.lang.String)}
   * .
   */
  @Test
