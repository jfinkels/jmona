 ...
 */
package jmona.example.ga.monalisa.output;
...
public class ImageOutputPostProcessorTester extends
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.output.ImageOutputPostProcessor#processAtInterval(jmona.EvolutionContext)}
   * .
   */
  @DirtiesContext
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.output.ImageOutputPostProcessor#setPeriod(int)}
   * .
   */
  @DirtiesContext
  @Test
  ...
  /**
   * Test method for
   * {@link jmona.example.ga.monalisa.output.ImageOutputPostProcessor#setHeight(int)}
   * and
   * {@link jmona.example.ga.monalisa.output.ImageOutputPostProcessor#setWidth(int)}
   * .
   */
  @Test
