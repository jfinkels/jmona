 ...
 * @since 0.3
 */
public class NewCoordinatePairTester {
  ...
  public void testRotateLeft() {
    ...
    pair.rotateLeft();
    assertEquals(Orientation.west(), pair);
    pair.rotateLeft();
    assertEquals(Orientation.south(), pair);
    pair.rotateLeft();
    assertEquals(Orientation.east(), pair);
    pair.rotateLeft();
    assertEquals(Orientation.north(), pair);
  }
