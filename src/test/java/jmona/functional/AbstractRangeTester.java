...
public class AbstractRangeTester {
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#hasNext()}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#iterator()}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#next()}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#AbstractRange(int)}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#AbstractRange(int, int)}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#AbstractRange(int, int, int)}.
   */
  @Test
  ...
  /**
   * Test method for {@link jmona.functional.AbstractRange#remove()}.
   */
  @Test
